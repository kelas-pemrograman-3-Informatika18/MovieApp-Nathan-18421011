        ...
        <div class="row">
          ...
          <div class="col">
            <q-banner inline-actions class="text-blue-grey-14">
              ...
              <div>Data Katalog Movie Anda</div>
            </q-banner>
          </div>
        </div>
      </div>
          ...
          <q-tr :props="props">
            ...
            <q-td key="aksi" :props="props">
              <div class="row q-gutter-md">
                <q-btn :to="{ name: 'FormEdit', params: { id: props.row._id }}" unelevated label="Edit" icon="edit" color="warning"/>
                <q-btn @click="deleteMovie(props.row._id)" unelevated label="Hapus" icon="delete" color="negative"/>
              </div>
            </q-td>
          </q-tr>
        </template>
